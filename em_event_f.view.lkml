view: em_event_f {
  ...
  measure: subscriber_order_cnt {
    ...
    type: count_distinct
    value_format_name: decimal_0
    sql: nullif( case when ${em_event_type_dm.order_bt} = 1 then ${em_subscriber_shk} else to_char( null ) end, 0 ) ;;
  ...
  measure: subscriber_signup_cnt {
    ...
    type: count_distinct
    value_format_name: decimal_0
    sql: nullif( case when ${em_event_type_dm.signup_bt} = 1 then ${em_subscriber_shk} else to_char( null ) end, 0 ) ;;
  ...
  measure: subscriber_sent_cnt {
    ...
    type: count_distinct
    value_format_name: decimal_0
    sql: nullif( case when ${em_event_type_dm.sent_bt} = 1 then ${em_subscriber_shk} else to_char( null ) end, 0 ) ;;
  ...
  measure: subscriber_opened_cnt {
    ...
    type: count_distinct
    value_format_name: decimal_0
    sql: nullif( case when ${em_event_type_dm.open_bt} = 1 then ${em_subscriber_shk} else to_char( null ) end, 0 ) ;;
  ...
  measure: subscriber_bounce_cnt {
    ...
    type: count_distinct
    value_format_name: decimal_0
    sql: nullif( case when ${em_event_type_dm.bounce_bt} = 1 then ${em_subscriber_shk} else to_char( null ) end, 0 ) ;;
  ...
  measure: subscriber_clicked_cnt {
    ...
    type: count_distinct
    value_format_name: decimal_0
    sql: nullif( case when ${em_event_type_dm.click_bt} = 1 then ${em_subscriber_shk} else to_char( null ) end, 0 ) ;;
  ...
  measure: subscriber_complaint_cnt {
    ...
    group_label: "Subscribers"
    type: count_distinct
    sql: nullif( case when ${em_event_type_dm.complaint_bt} = 1 then ${em_subscriber_shk} else to_char( null ) end, 0 ) ;;
  ...
  measure: subscriber_unsub_cnt {
    ...
    group_label: "Subscribers"
    type: count_distinct
    sql: nullif( case when ${em_event_type_dm.unsub_bt} = 1 then ${em_subscriber_shk} else to_char( null ) end, 0 ) ;;
